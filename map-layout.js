...
const controls=original.map(([x,y])=>[x,340+(y-340)*1.4]),route=[];
...
root.KnollMap={route,pads:[[125,270],[260,325],[370,520],[520,280],[420,120],[590,105],[570,440],[790,365],[850,595],[1010,515],[1110,330],[1100,115],[245,545],[710,565],[720,220],[900,215]]};
})(globalThis);
